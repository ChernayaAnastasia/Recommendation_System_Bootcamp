...
def upload_file():
    ...
    if file and allowed_file(file.filename):
        ...
        answer['Успех'] = True
        answer['Путь'] = UPLOAD_FOLDER + '\\' + filename
        return answer
    else:
...
def start_model(): 
    run_model(data_folder=UPLOAD_FOLDER)
    answer = ANSWER.copy()
    answer['Задача'] = 'start'
    answer['Путь'] = UPLOAD_FOLDER + '/outputdata.csv'
    answer['Сообщение'] = 'Модель успешно отработала!'
    answer['Успех'] = True
    return answer
